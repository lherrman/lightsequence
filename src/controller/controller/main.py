...
from src.controller.midi.light_software import LightSoftware
from src.controller.midi.light_software_sim import LightSoftwareSim
from src.controller.devices.launchpad import LaunchpadMK2, ButtonType
from src.controller.controller.preset_manager import PresetManager
from src.controller.controller.background_animator import BackgroundManager
from src.controller.controller.sequence import SequenceManager, SequenceState
from src.controller.common.config import get_config
from src.controller.common.enums import AppState
...
class LightController:
    ...
    def _update_clear_button_display(self) -> None:
        ...
        from src.controller.common.config import get_button_type_enum
            ...
            for row in range(3):
                ...
                if has_preset:
                    ...
                    if self.current_app_state == AppState.SAVE_MODE:
                        ...
                        from src.controller.common.utils import hex_to_rgb
