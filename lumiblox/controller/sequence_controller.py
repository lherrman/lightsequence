...
class SequenceController:
    ...
    def start_playback(self, index: t.Tuple[int, int]) -> bool:
        ...
        # For single-step sequences, just trigger the step and stop
        ...
        # For multi-step sequences, start playback thread
